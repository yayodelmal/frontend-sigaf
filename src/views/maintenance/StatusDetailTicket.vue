<template>
  <div>
    <base-card color="blueS" class="px-5 py-3" title="Intento de contacto">
      <v-data-table
        :headers="headers"
        :items="items"
...
<script>
import StatusDetailTicket from '../../models/StatusDetailTicket'
...
export default {
  ...
  data: () => ({
    ...
    editedIndex: -1,
    editedItem: new StatusDetailTicket(),
    defaultItem: new StatusDetailTicket(),
    message: '',
  ...
  computed: {
    ...mapGetters({ items: 'statusDetailTicket/statusDetailTickets' }),
    descriptionErrors() {
      const errors = []
    ...
    formTitle() {
      return this.editedIndex === -1
        ? 'Crear intento contacto'
        : 'Editar intento contacto'
    },
    description() {
  ...
  methods: {
    ...mapActions({
      fetchItems: 'statusDetailTicket/fetchStatusDetailTickets',
      postItem: 'statusDetailTicket/postStatusDetailTicket',
      putItem: 'statusDetailTicket/putStatusDetailTicket',
      removeItem: 'statusDetailTicket/deleteStatusDetailTicket'
    }),
    editItem(item) {
