<template>
  <div>
    <base-card color="blueS" class="px-5 py-3" title="Origen de ticket">
      <v-data-table
        :headers="headers"
        :items="items"
...
<script>
import SourceTicket from '../../models/SourceTicket'
...
export default {
  ...
  data: () => ({
    ...
    editedIndex: -1,
    editedItem: new SourceTicket(),
    defaultItem: new SourceTicket(),
    message: '',
  ...
  computed: {
    ...mapGetters({ items: 'sourceTicket/sourceTickets' }),
    descriptionErrors() {
      const errors = []
    ...
    formTitle() {
      return this.editedIndex === -1
        ? 'Crear origen de ticket'
        : 'Editar origen de ticket'
    },
    description() {
  ...
  methods: {
    ...mapActions({
      fetchItems: 'sourceTicket/fetchSourceTickets',
      postItem: 'sourceTicket/postSourceTicket',
      putItem: 'sourceTicket/putSourceTicket',
      removeItem: 'sourceTicket/deleteSourceTicket',
      fetchTickets: 'sourceTicket/fetchTickets'
    }),
    editItem(item) {
