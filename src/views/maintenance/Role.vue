<template>
  <div>
    <base-card color="blueS" class="px-5 py-3" title="Rol de usuario">
      <v-data-table
        :headers="headers"
        :items="items"
...
export default {
  ...
  methods: {
    ...mapActions({
      fetchItems: 'role/fetchRoles',
      postItem: 'role/postRole',
      putItem: 'role/putRole',
      removeItem: 'role/deleteRole'
    }),
    editItem(item) {
