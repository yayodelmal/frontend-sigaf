...
export default {
  ...
  methods: {
    ...
    confirmDelete() {
      this.deleteStatusTicket(this.editedItem).then(({ success, error }) => {
        if (success) {
          this.snackbar = true
    ...
    save() {
      if (this.validate()) {
        if (this.editedIndex > -1) {
          this.putStatusTicket(this.editedItem).then(({ success, error }) => {
            if (success) {
              this.snackbar = true
              this.message = this.successMessage
            } else {
          ...
          this.postStatusTicket(this.editedItem).then(({ success, error }) => {
            if (success) {
              this.snackbar = true
              this.message = this.successMessage
            } else {
